...
|**MOTChallenge**|MOT15/16/17/20|2D BBox|[website](https://motchallenge.net/)|[code](trackeval/datasets/sat_challenge_2d_box.py)|[format](docs/MOTChallenge-format.txt)|
